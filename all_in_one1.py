...
file_path = "/media/wxk/data2/project/product/jvben/data/jvben_source/yongsheng.txt"
role_file_path = "/media/wxk/data2/project/product/jvben/data/out/yongsheng_role.txt"
...
for item_section_index, item_sction in xiaoshuo_ins.section_map.items():
    xiaoshuo_map[item_section_index] = item_sction.dump_jvben()
